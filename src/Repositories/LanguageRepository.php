...
class LanguageRepository extends Repository {
	 ...
	 *  If the attributes are not valid, a null response is given and the errors can be retrieved through
	 *  validationErrors()
	 *
	...
	public function findByLocale( $locale ) {
		return Cache::remember( 'language_repository_cache_by_locale_' . $locale, 60, function () use ( $locale ) {
	...
	public function findTrashedByLocale( $locale ) {
		return Cache::remember( 'language_repository_cache_trashed_by_locale_' . $locale, 60, function () use ( $locale ) {
	...
	public function allExcept( $locale ) {
		return Cache::remember( 'language_repository_cache_all_except_locale_' . $locale, 60, function () use ( $locale ) {
